...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<LinearLayout>(R.id.pdf).setOnClickListener {
            startActivity(Intent(this, LihatPdf::class.java))
        }
        
        findViewById<LinearLayout>(R.id.docx).setOnClickListener {
            startActivity(Intent(this, LihatDocx::class.java))
        }
